...
import { KeyboardAvoidingView, Platform, ScrollView, Text, TextInput, TouchableOpacity, View, VirtualizedList } from "react-native";
...
export default function SignIn() {
    ...
    return (
        <SafeAreaView className="flex-1 bg-[rgb(75_169_188)] w-full">
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1, alignItems: 'center',  justifyContent:"center" }} showsVerticalScrollIndicator={false}>

            <View className="bg-white w-[90%] max-w-[380px] mx-6 px-6 py-8 rounded-xl shadow-md">
                <Text className="text-[rgb(65_133_149)] text-4xl font-bold text-center mb-8">Relay</Text>
                <View className="mb-6">
                    <TextInput 
            ...
            <View className="items-center mt-5">
                ...
                <Text className="text-center mt-4 text-gray-500">By signing up, you agree to our Terms, Data{'\n'}Policy and Cookies Policy.</Text>
            </View>
            </View>
            
            <View className="bg-white w-[90%] max-w-[380px]x-4 mt-4 py-4 rounded-xl shadow-sm   flex-row justify-center items-center">
                <Text className="text-gray-600 text-sm">Already have an account? 

                </Text>
                <TouchableOpacity>
                    <Text className="text-[rgb(65_133_149)] font-bold text-sm">Log in</Text>
                </TouchableOpacity>
          </View>
                </ScrollView>
            </KeyboardAvoidingView>
